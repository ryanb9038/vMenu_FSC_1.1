...
namespace vMenuClient
{
    public class MiscSettings
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuItem teleportMenuBtn = new MenuItem("Teleport Locations", "Teleport to pre-configured locations.");
            ...
            MenuCheckboxItem locationBlips = new MenuCheckboxItem("Location Blips", "Shows the blips on the map for some common locations.", ShowLocationBlips);
            MenuCheckboxItem playerBlips = new MenuCheckboxItem("Hide Player Blips", "Hides the blips on the map for all players.", ShowPlayerBlips);
